...
class TransactionHistoryPage(ctk.CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        self.__transactionsGenreStats = Transaction.getClosedTransactionsDataGenre(globals.currentUser)
        self.__transactionRenterAgeStats = Transaction. getClosedTransactionsDataRenterAge(globals.currentUser)
