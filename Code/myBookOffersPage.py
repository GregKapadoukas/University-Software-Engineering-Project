...
class MyBookOffersPage(ctk.CTkFrame):
    ...
    def editFunc(self,offer):
        ...
        self.__deliveryTypeLocalMeet = ctk.CTkRadioButton(self.__editFrame, text="Local Meet", variable=self.__radiobutton_variable, value=1)
        self.__deliveryTypePost = ctk.CTkRadioButton(self.__editFrame, text="Postal delivery",variable=self.__radiobutton_variable, value=2)
